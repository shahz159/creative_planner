(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('dayjs'), require('dayjs/plugin/localeData'), require('dayjs/plugin/localizedFormat'), require('dayjs/plugin/isoWeek'), require('dayjs/plugin/weekOfYear'), require('dayjs/plugin/customParseFormat')) :
    typeof define === 'function' && define.amd ? define('ngx-daterangepicker-material', ['exports', '@angular/common', '@angular/core', '@angular/forms', 'dayjs', 'dayjs/plugin/localeData', 'dayjs/plugin/localizedFormat', 'dayjs/plugin/isoWeek', 'dayjs/plugin/weekOfYear', 'dayjs/plugin/customParseFormat'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-daterangepicker-material'] = {}, global.ng.common, global.ng.core, global.ng.forms, global.dayjs, global.localeData, global.LocalizedFormat, global.isoWeek, global.week, global.customParseFormat));
}(this, (function (exports, common, core, forms, dayjs$1, localeData, LocalizedFormat, isoWeek, week, customParseFormat) { 'use strict';
    ...
    var dayjs__namespace = /*#__PURE__*/_interopNamespace(dayjs$1);
    var localeData__namespace = /*#__PURE__*/_interopNamespace(localeData);
    ...
    var week__namespace = /*#__PURE__*/_interopNamespace(week);
    ...
    ***************************************************************************** */
    ...
    var dayjs = dayjs__namespace;
    dayjs.extend(localeData__namespace);
    ...
    dayjs$1.extend(localeData__namespace);
    dayjs$1.extend(LocalizedFormat__namespace);
    dayjs$1.extend(isoWeek__namespace);
    dayjs$1.extend(week__namespace);
    dayjs$1.extend(customParseFormat__namespace);
    var SideEnum;
    (function (SideEnum) {
        SideEnum["left"] = "left";
    ...
    var DaterangepickerComponent = /** @class */ (function () {
        function DaterangepickerComponent(el, _ref, _localeService) {
            ...
            this.startDate = dayjs__namespace().startOf('day');
            this.endDate = dayjs__namespace().endOf('day');
            this.dateLimit = null;
            ...
            this.clearClicked = new core.EventEmitter();
        }
        Object.defineProperty(DaterangepickerComponent.prototype, "minDate", {
            // accessors
            set: function (value) {
                if (dayjs$1.isDayjs(value)) {
                    this._minDate = value;
                }
                else if (typeof value === 'string') {
                    this._minDate = dayjs__namespace(value);
                }
                else {
                    this._minDate = null;
                }
        ...
        Object.defineProperty(DaterangepickerComponent.prototype, "maxDate", {
            set: function (value) {
                if (dayjs$1.isDayjs(value)) {
                    ...
                    this._maxDate = dayjs__namespace(value);
                }
                else {
                    this._maxDate = null;
                }
                ...
                for (var range in this.ranges) {
                    if (this.ranges[range]) {
                        if (typeof this.ranges[range][0] === 'string') {
                            start = dayjs__namespace(this.ranges[range][0], this.locale.format);
                        }
                        else {
                            start = dayjs__namespace(this.ranges[range][0]);
                        }
                        if (typeof this.ranges[range][1] === 'string') {
                            end = dayjs__namespace(this.ranges[range][1], this.locale.format);
                        }
                        else {
                            end = dayjs__namespace(this.ranges[range][1]);
                        }
        ...
        DaterangepickerComponent.prototype.renderCalendar = function (side) {
            ...
            var daysInMonth = dayjs__namespace(new Date(year, month)).daysInMonth();
            var firstDay = dayjs__namespace(new Date(year, month, 1));
            var lastDay = dayjs__namespace(new Date(year, month, daysInMonth));
            var lastMonth = dayjs__namespace(firstDay).subtract(1, 'month').month();
            var lastYear = dayjs__namespace(firstDay).subtract(1, 'month').year();
            var daysInLastMonth = dayjs__namespace(new Date(lastYear, lastMonth)).daysInMonth();
            ...
            var curDate = dayjs__namespace(new Date(lastYear, lastMonth, startDay, 12, minute, second));
            for (var i = 0, col = 0, row = 0; i < 42; i++, col++, curDate = dayjs__namespace(curDate).add(24, 'hour')) {
                if (i > 0 && col % 7 === 0) {
                    col = 0;
                    row++;
                }
            ...
            if (this.endDate === null && this.dateLimit) {
                ...
                if (this.customRangeDirection) {
                    minDate = this.getMinDate();
                    var minLimit = this.startDate.clone().subtract(this.dateLimit, 'day').endOf('day');
            ...
            if (this.showDropdowns) {
                ...
                var realCurrentYear = dayjs__namespace().year();
        ...
        DaterangepickerComponent.prototype.setStartDate = function (startDate) {
            if (typeof startDate === 'string') {
                this.startDate = dayjs__namespace(startDate, this.locale.format);
            }
            if (typeof startDate === 'object') {
                this.pickingDate = true;
                this.startDate = dayjs__namespace(startDate);
            }
            if (!this.timePicker) {
                this.pickingDate = true;
                this.startDate = this.startDate.startOf('day');
        ...
        DaterangepickerComponent.prototype.setEndDate = function (endDate) {
            if (typeof endDate === 'string') {
                this.endDate = dayjs__namespace(endDate, this.locale.format);
            }
            if (typeof endDate === 'object') {
                this.pickingDate = false;
                this.endDate = dayjs__namespace(endDate);
            }
            if (!this.timePicker) {
                this.pickingDate = false;
        ...
        DaterangepickerComponent.prototype._buildLocale = function () {
            ...
            if (!this.locale.format) {
                if (this.timePicker) {
                    this.locale.format = dayjs$1.localeData().longDateFormat('lll');
                }
                else {
                    this.locale.format = dayjs$1.localeData().longDateFormat('L');
                }
            }
        };
    ...
    DaterangepickerComponent.propDecorators = {
        ...
        emptyWeekColumnClass: [{ type: core.Input }],
        ...
        cancelClicked: [{ type: core.Output }],
        clearClicked: [{ type: core.Output }],
    ...
    var DaterangepickerDirective = /** @class */ (function () {
        ...
        DaterangepickerDirective.prototype.ngOnInit = function () {
            ...
            this.picker.clearClicked.asObservable().subscribe(function () {
                _this.clearClicked.emit();
            });
        ...
        DaterangepickerDirective.prototype.inputChanged = function (e) {
            ...
            if (dateString.length === 2) {
                start = dayjs__namespace(dateString[0], this.picker.locale.format);
                end = dayjs__namespace(dateString[1], this.picker.locale.format);
            }
            if (this.singleDatePicker || start === null || end === null) {
                start = dayjs__namespace(e.target.value, this.picker.locale.format);
                end = start;
            }
    ...
    DaterangepickerDirective.propDecorators = {
        ...
        endDateChanged: [{ type: core.Output }],
        clearClicked: [{ type: core.Output }],
        disabled: [{ type: core.HostBinding, args: ['disabled',] }],
