 ...
 */
var MedianPrice = /** @class */ (function (_super) {
    __extends(MedianPrice, _super);
    ...
    Object.defineProperty(MedianPrice.prototype, "_createSeries", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
     ...
     * @ignore
     */
    Object.defineProperty(MedianPrice.prototype, "prepareData", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
            ...
            if (this.series) {
                ...
                $array.each(data_1, function (dataItem) {
                    ...
                    if (value != null) {
                        i_1++;
                        median_1 += value / period_1;
                        if (i_1 >= period_1) {
                            if (i_1 > period_1) {
                                var valueToRemove = data_1[index_1 - period_1].value_y;
                                if (valueToRemove != null) {
                                    median_1 -= valueToRemove / period_1;
                                }
                            }
                            dataItem.median = median_1;
                        }
                    }
                    index_1++;
                });
